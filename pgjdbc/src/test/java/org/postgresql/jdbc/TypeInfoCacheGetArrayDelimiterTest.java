...
public class TypeInfoCacheGetArrayDelimiterTest {
  ...
  private static final ArrayList<PgTypeStruct> types = new ArrayList<PgTypeStruct>() {
    {
      add(new PgTypeStruct("ns", "type"));
      add(new PgTypeStruct("public", "type"));
      add(new PgTypeStruct("pg_catalog", "box"));
  ...
  public static Iterable<Object[]> data() {
    ...
    cases.add(new Object[]{new PgTypeStruct("pg_catalog", "int2"), DEFAULT_DELIMITER});
    cases.add(new Object[]{new PgTypeStruct("pg_catalog", "text"), DEFAULT_DELIMITER});
    cases.add(new Object[]{new PgTypeStruct("pg_catalog", "box"), ';'});
    cases.add(new Object[]{new PgTypeStruct("ns", "type"), DEFAULT_DELIMITER});
    cases.add(new Object[]{new PgTypeStruct("public", "type"), DEFAULT_DELIMITER});
    return cases;
  }
