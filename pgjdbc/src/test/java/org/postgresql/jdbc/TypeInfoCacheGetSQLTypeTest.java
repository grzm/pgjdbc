...
public class TypeInfoCacheGetSQLTypeTest extends BaseTest4 {
  ...
  public static Iterable<Object[]> data() {
    ...
    cases.add(new Object[]{new PgTypeStruct("pg_catalog", "int2"), SQLType.SMALLINT});
    cases.add(new Object[]{new PgTypeStruct("pg_catalog", "int4"), SQLType.INTEGER});
    cases.add(new Object[]{new PgTypeStruct("pg_catalog", "numeric"), SQLType.NUMERIC});
    cases.add(new Object[]{new PgTypeStruct(CUSTOM_SCHEMA, DISTINCT_TYPE), SQLType.DISTINCT});
    cases.add(new Object[]{new PgTypeStruct(CUSTOM_SCHEMA, STRUCT_TYPE), SQLType.STRUCT});
    cases.add(new Object[]{new PgTypeStruct(CUSTOM_SCHEMA, VARCHAR_TYPE), SQLType.VARCHAR});
    return cases;
  }
