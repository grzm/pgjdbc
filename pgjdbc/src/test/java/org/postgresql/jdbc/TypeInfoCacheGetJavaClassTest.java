...
public class TypeInfoCacheGetJavaClassTest extends BaseTest4 {
  ...
  public static Iterable<Object[]> data() {
    ...
    cases.add(
        new Object[]{new PgTypeStruct("pg_catalog", "numeric"), Types.NUMERIC,
            "java.math.BigDecimal"});
    cases.add(new Object[]{new PgTypeStruct(CUSTOM_SCHEMA, DISTINCT_TYPE), Types.DISTINCT, null});
    cases.add(new Object[]{new PgTypeStruct(CUSTOM_SCHEMA, STRUCT_TYPE), Types.STRUCT, null});
    cases.add(new Object[]{new PgTypeStruct(CUSTOM_SCHEMA, VARCHAR_TYPE), Types.VARCHAR, null});
    return cases;
  }
