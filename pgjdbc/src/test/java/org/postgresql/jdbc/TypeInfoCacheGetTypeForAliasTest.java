...
public class TypeInfoCacheGetTypeForAliasTest extends BaseTest4 {
  ...
  public static Iterable<Object[]> data() {
    Collection<Object[]> aliasing = new ArrayList<>();
    aliasing.add(new Object[]{"int2", new String[]{"smallint"}});
    aliasing.add(new Object[]{"int4", new String[]{"integer", "int"}});
    aliasing.add(new Object[]{"float8", new String[]{"float"}});
    aliasing.add(new Object[]{"bool", new String[]{"boolean"}});
    aliasing.add(new Object[]{"numeric", new String[]{"decimal"}});
