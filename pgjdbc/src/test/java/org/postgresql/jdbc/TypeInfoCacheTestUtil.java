...
class TypeInfoCacheTestUtil {
  ...
  public static class PgTypeStruct {
    ...
    static final PgTypeStruct UNPARSEABLE = new PgTypeStruct((String) "*unparseable*", "*unparseable*");
  ...
  static class PgTypeSet {
    private final HashMap<Integer, PgTypeStruct> oidToType = new HashMap<>();
    private final HashMap<PgTypeStruct, Integer> typeToOid = new HashMap<>();
    private final ArrayList<String> quotedTypeNames = new ArrayList<>();
    private final HashSet<String> quotedSchemaNames = new HashSet<>();
    private final HashSet<PgTypeStruct> userDefinedTypeArrayTypes = new HashSet<>();
    ...
    PgTypeSet(ArrayList<PgTypeStruct> types) {
      this.types = types;
    }
    ...
    static PgTypeSet createAndInstall(ArrayList<PgTypeStruct> types, Connection conn)
        throws SQLException {
